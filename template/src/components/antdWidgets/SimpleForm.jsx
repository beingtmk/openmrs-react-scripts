...
import { ARangePicker, ASwitch, ASlider, ASelect, AOption, AInputNumber, ADynamicFieldSet } from '@openmrs/react-components'; 
...
const SimpleForm = props => {
  ...
  return (
    <form onSubmit={handleSubmit} style={{margin: "20px"}}>
      ...
      <FieldArray name="members" component={ADynamicFieldSet} keys={[{key: "firstName"}, {key: "lastName"}, {key: "mobile"}]}/>
